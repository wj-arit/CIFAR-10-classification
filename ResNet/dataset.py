...
full_train_dataset = datasets.CIFAR10('/home/user/CIFAR-10-classification/data',download=True,train=True,transform=train_transform)
full_test_dataset = datasets.CIFAR10('/home/user/CIFAR-10-classification/data',download=True,train=False,transform=test_transform)
